          ...
          <form onSubmit={handleSendMessage} className="relative">
            <div className="relative">
              <textarea
                ...
                className="w-full min-h-[52px] max-h-32 resize-none bg-muted text-foreground placeholder-muted-foreground rounded-xl pl-4 pr-12 py-3 focus:ring-2 focus:ring-primary/20 focus:outline-none focus:bg-muted/80 transition-all text-base"
                disabled={isLoading}
                rows={1}
              />
              <button
